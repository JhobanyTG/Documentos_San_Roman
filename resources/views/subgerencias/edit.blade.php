        ...
        <div class="card-body">
            <form action="{{ route('subgerencias.update', ['gerencia' => $gerencia->id, 'subgerencia' => $subgerencia->id]) }}" method="POST">
                ...
                <div class="row">
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="nombre" class="form-control subgerencia" id="nombre" value="{{ $subgerencia->nombre }}" required>
                        </div>
                    ...
                    <div class="col-md-6">
                        <div class="form-group">
                            ...
                            <input type="text" name="telefono" class="form-control subgerencia" id="telefono" value="{{ $subgerencia->telefono }}" required>
                        </div>
                        ...
                        <div class="row">
                            ...
                            <div class="form-group mt-3">
                                ...
                                <input type="text" name="direccion" class="form-control subgerencia" id="direccion" value="{{ $subgerencia->direccion }}" required>
                            </div>
                        </div>
                    </div>
                </div>
                ...
                <div class="mt-4 text-center">
                    <a href="{{ route('gerencias.show', $gerencia->id) }}" class="btn btn-secondary btn-subgerencia me-2"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Cancelar
                    </a>
                    <button type="submit" class="btn btn-primary btn-subgerencia ms-2"><i class="fa fa-save" aria-hidden="true"></i> Guardar Cambios</button>
                </div>
            </form>
        </div>
    </div>
