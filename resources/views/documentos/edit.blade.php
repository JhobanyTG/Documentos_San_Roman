                    ...
                    <form action="{{ route('documentos.update', $documento->id) }}" method="POST"
                        ...
                        <div class="row">
                            ...
                            <div class="col-md-8">
                                ...
                                <div class="container-input mt-0">
                                    <a href="{{ route('documentos.index') }}" class="btn btn-warning btn-documento me-2">
                                        <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Cancelar
                                    </a>
                                    <button type="submit" class="btn btn-success btn-documento ms-2">
