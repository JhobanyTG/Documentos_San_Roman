...
@section('content')
    <div class="container mt-4 form_subusuario">
        <h2 class="form_title_subusuario">Editar Subusuario</h2>
        <form id="editForm" action="{{ route('subusuarios.update', ['gerencia' => $gerencia->id, 'subgerencia' => $subgerencia->id, 'subusuario' => $subusuario->id]) }}" method="POST" class="form_persona_user" enctype="multipart/form-data">
            ...
            <div class="mt-3 botones_form_persona text-center">
                <a href="{{ route('gerencias.show', $gerencia->id) }}" class="btn btn-form btn-subusuario me-2">
                    <i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Cancelar
                </a>
                <a href="{{ route('usuarios.cambiarContrasena', $subusuario->user->id) }}" class="btn btn-subusuario ms-2"><i class="fa fa-unlock-alt" aria-hidden="true"></i>
                    Cambiar Contraseña</a>
                <button type="submit" class="btn btn-form btn-subusuario ms-2">
