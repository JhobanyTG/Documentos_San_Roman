                ...
                <div class="col-md-12">
                    <form action="{{ route('gerencias.store') }}" method="POST">
                        ...
                        <div class="mt-4 text-center">
                            <a href="{{ route('gerencias.index') }}" class="btn btn-secondary btn-gerencia me-2"><i class="fa fa-arrow-circle-left" aria-hidden="true"></i> Cancelar</a>
                            <button type="submit" class="btn btn-primary btn-gerencia ms-2"><i class="fa fa-plus" aria-hidden="true"></i> Crear</button>
                        </div>
                    </form>
                </div>
            </div>
