...
<div class="container form_tipodocumento">
    <h1 class="form_title_tipo">Editar Tipo de Documento</h1>
    <form action="{{ route('tipodocumento.update', $tipodocumento->id) }}" method="POST">
        ...
        <button type="submit" class="btn btn-primary btn-tipo"><i class="fa fa-save" aria-hidden="true"></i> Guardar Cambios</button>
    </form>
</div>
@endsection
